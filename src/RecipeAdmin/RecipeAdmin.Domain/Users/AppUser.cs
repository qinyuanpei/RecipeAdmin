...
namespace RecipeAdmin.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update RecipeAdminDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update RecipeAdminEfCoreEntityExtensionMappings to extend the IdentityUser entity
